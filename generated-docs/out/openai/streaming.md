...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "zio" % "0.11.0"
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "pekko" % "0.11.0"
...
```scala
//> using dep com.softwaremill.sttp.ai::pekko:0.11.0
...
"com.softwaremill.sttp.ai" %% "akka" % "0.11.0"
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.11.0"
