...
```scala
//> using dep com.softwaremill.sttp.ai::fs2:0.5.6
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "zio" % "0.5.6"
...
```scala
//> using dep com.softwaremill.sttp.ai::zio:0.5.6
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "pekko" % "0.5.6"
...
```scala
//> using dep com.softwaremill.sttp.ai::pekko:0.5.6
...
"com.softwaremill.sttp.ai" %% "akka" % "0.5.6"
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.5.6"
...
```scala
//> using dep com.softwaremill.sttp.ai::ox:0.5.6
