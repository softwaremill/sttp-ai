...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "fs2" % "0.5.1+17-73bc7345+20260714-1005-SNAPSHOT"
...
```scala
//> using dep com.softwaremill.sttp.ai::fs2:0.5.1+17-73bc7345+20260714-1005-SNAPSHOT
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.5.1+17-73bc7345+20260714-1005-SNAPSHOT"
...
```scala
//> using dep com.softwaremill.sttp.ai::ox:0.5.1+17-73bc7345+20260714-1005-SNAPSHOT
