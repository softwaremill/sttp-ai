...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "fs2" % "0.5.5"
...
```scala
//> using dep com.softwaremill.sttp.ai::fs2:0.5.5
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.5.5"
...
```scala
//> using dep com.softwaremill.sttp.ai::ox:0.5.5
