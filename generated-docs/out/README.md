...
- `0.5.1+14-45313544+20260714-0930-SNAPSHOT` and other mdoc variables are **not** substituted in the local watch mode. For a fully-rendered preview, run `sbt "docs/mdoc"` from the repo root and serve `generated-docs/out/` instead.
