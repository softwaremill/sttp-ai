...
- `0.11.0` and other mdoc variables are **not** substituted in the local watch mode. For a fully-rendered preview, run `sbt "docs3/mdoc"` from the repo root and serve `generated-docs/out/` instead.
