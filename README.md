...
```sbt
"com.softwaremill.sttp.ai" %% "openai" % "0.9.0"
```
...
```sbt
"com.softwaremill.sttp.ai" %% "claude" % "0.9.0"

// For streaming support, add one or more (these modules are shared across OpenAI, Claude, and Gemini):
"com.softwaremill.sttp.ai" %% "fs2" % "0.9.0"    // cats-effect/fs2
"com.softwaremill.sttp.ai" %% "zio" % "0.9.0"    // ZIO
"com.softwaremill.sttp.ai" %% "akka" % "0.9.0"   // Akka Streams (Scala 2.13 only)
"com.softwaremill.sttp.ai" %% "pekko" % "0.9.0"  // Pekko Streams
"com.softwaremill.sttp.ai" %% "ox" % "0.9.0"    // Ox direct-style (Scala 3 only)
```
...
```sbt
"com.softwaremill.sttp.ai" %% "gemini" % "0.9.0"
