...
```sbt
"com.softwaremill.sttp.ai" %% "openai" % "0.4.8"
```
...
```sbt
"com.softwaremill.sttp.ai" %% "claude" % "0.4.8"

// For streaming support, add one or more:
"com.softwaremill.sttp.ai" %% "claude-streaming-fs2" % "0.4.8"    // cats-effect/fs2
"com.softwaremill.sttp.ai" %% "claude-streaming-zio" % "0.4.8"    // ZIO
"com.softwaremill.sttp.ai" %% "claude-streaming-akka" % "0.4.8"   // Akka Streams (Scala 2.13 only)
"com.softwaremill.sttp.ai" %% "claude-streaming-pekko" % "0.4.8"  // Pekko Streams
"com.softwaremill.sttp.ai" %% "claude-streaming-ox" % "0.4.8"    // Ox direct-style (Scala 3 only)
```
...
//> using dep com.softwaremill.sttp.ai::openai:0.4.8
...
```scala mdoc:compile-only
//> using dep com.softwaremill.sttp.ai::claude:0.4.8
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "fs2" % "0.4.8"
...
```scala mdoc:compile-only
//> using dep com.softwaremill.sttp.ai::fs2:0.4.8
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.4.8"
...
```scala
//> using dep com.softwaremill.sttp.ai::ox:0.4.8
