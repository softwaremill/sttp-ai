...
```sbt
"com.softwaremill.sttp.ai" %% "openai" % "0.4.1"
```
...
```sbt
"com.softwaremill.sttp.ai" %% "claude" % "0.4.1"

// For streaming support, add one or more:
"com.softwaremill.sttp.ai" %% "claude-streaming-fs2" % "0.4.1"    // cats-effect/fs2
"com.softwaremill.sttp.ai" %% "claude-streaming-zio" % "0.4.1"    // ZIO
"com.softwaremill.sttp.ai" %% "claude-streaming-akka" % "0.4.1"   // Akka Streams (Scala 2.13 only)
"com.softwaremill.sttp.ai" %% "claude-streaming-pekko" % "0.4.1"  // Pekko Streams
"com.softwaremill.sttp.ai" %% "claude-streaming-ox" % "0.4.1"    // Ox direct-style (Scala 3 only)
```
...
//> using dep com.softwaremill.sttp.ai::openai:0.4.1
...
```scala mdoc:compile-only
//> using dep com.softwaremill.sttp.ai::claude:0.4.1
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "fs2" % "0.4.1"
...
```scala mdoc:compile-only
//> using dep com.softwaremill.sttp.ai::fs2:0.4.1
...
```scala
// sbt dependency
"com.softwaremill.sttp.ai" %% "ox" % "0.4.1"
...
```scala
//> using dep com.softwaremill.sttp.ai::ox:0.4.1
